...
class DisplayEventTest < Minitest::Test
  def test_assigns_time
    event = DisplayEvent.new(
  ...
  def test_start_only
    ...
    event = DisplayEvent.new(starts_at: start, ends_at: finish, summary: "foo", timezone: "America/Chicago")
  ...
  def test_event_with_same_start_and_end_at_top_of_hour
    ...
    event = DisplayEvent.new(starts_at: start, ends_at: start, summary: "foo", timezone: "America/Chicago")
  ...
  def test_event_over_time_change
    event = DisplayEvent.new(starts_at: "2023-11-01", ends_at: "2023-11-08", summary: "foo")
  ...
  def test_does_not_strip_things_we_should_keep
    event = DisplayEvent.new(starts_at: "2023-11-01", ends_at: "2023-11-08", summary: "foo bar / \\ ° - _ & : + , ()@ <> '’#")

    assert_equal("foo bar / \\ ° - _ & : + , ()@ <> '’#", event.summary)
  end

  def test_strips_non_ascii
    event = DisplayEvent.new(starts_at: "2023-11-01", ends_at: "2023-11-08", summary: " ‍ meeting")
