...
class DemoDisplayContent
  def call(timezone: "UTC", current_time: nil)
    ...
    out[:day_groups] = build_day_groups(current_time, timezone)
  ...
  def build_day_groups(current_time, timezone)
    ...
    (0...5).map do |day_index|
      ...
      events = events_for_day(day_index, date, current_time, vacation, timezone)
  ...
  def events_for_day(day_index, date, current_time, vacation, timezone)
    daily = []
    periodic = []
